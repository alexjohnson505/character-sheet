var templates = {
	"spellCast" : 'Name : {{name}}<br>Description : {{description}}<br>Damage Type : {{damage-type}}<br>Attribute: {{attribute}}<br>Attribute Mod: {{attributeMod}}<br><br><i class="sum"><strong>{{damage}} : Spell Damage</strong></i><br>Spell DC: {{spellDC}}',
